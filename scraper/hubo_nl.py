"""Hubo (EUR, Netherlands — DIY chain; Shopify (same platform as Bouwmaat)).
...
(verified 2026-09-25), while Hubo serves plain sitemaps to anyone.
...
BASE = "https://www.hubo.nl"
OUT = "data/latest/hubo_nl.jsonl"
...
if __name__ == "__main__":
    ...
    print("hubo_nl: %d products -> %s" % (len(rows), OUT))
